...
// リソース所有者をクライアントから認可サーバーに送り、そのリソース所有者によって必要な権限を移譲されるよう認可サーバーにリクエストする
...
// リソース所有者を認可サーバーからクライアントに送り
// 認可コードを認可サーバーからクライアントへ渡すようにリクエストされる
app.get('/callback', function(req, res){
	...
	if (req.query.error) {
		...
		res.render('error', {error: 'リソース所有者がキャンセルしました'});
		return;
	}
